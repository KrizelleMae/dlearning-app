...
// APPROVED
$get_approved = mysqli_query($con, "select COUNT(*) FROM application where status = 'approved' AND program = '$program';");
...
// PENDING
$get_pending = mysqli_query($con, "select COUNT(*) FROM application where status = 'pending' AND program = '$program';");
