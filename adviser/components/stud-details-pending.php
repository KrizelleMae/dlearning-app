  ...
  <div class="bg-white shadow-lg overflow-hidden sm:rounded-lg">
    <div class="px-4 py-5 sm:px-6">
      ...
      <div class="text-gray-500">
        ...
        <span
          class="<?php if($row['status'] == "pending") {echo "bg-blue-500"; }?> text-white text-xs font-bold mr-2 px-2.5 py-0.5 rounded"
    ...
    <div class="border-t border-gray-200">
      <dl>
        ...
        <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
          <dt class="text-sm font-medium text-gray-500"><i class="fa fa-graduion-cap text-gray-500 font-bold"></i> Degree</dt>
